...
export const vaccineFields = [
    ...
    { label: "Type", type: "select", key: "type", options: ["Infant", "Adult"] },
    { label: "Category", type: "select", key: "category", options: ["Birth", "Routine"] },
    { label: "Sub-category", type: "select", key: "subCategory", options: ["Mandatory", "Optional"] },
    ...
    { label: "Site", type: "select", key: "site", options: ["Deltoid", "Thigh", "Arm"] },
