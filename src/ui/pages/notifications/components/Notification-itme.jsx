...
import { ConfirmDeleteModal } from "../../../components/confirm-delete-model"
...
export default function NotificationItem({
  ...
  return (
    ...
    >
      <img
        src={avatarUrl || "/placeholder.svg?height=48&width=48&query=avatar"}
        alt={`${name} avatar`}
      ...
      <div className="flex shrink-0 items-center gap-3">
        <button
          type="button"
          aria-label={`Delete notification from ${name}`}
        ...
        >
         <img src={ICONS.deletenotification} alt="del" />
        </button>
        <ConfirmDeleteModal
  open={open}
